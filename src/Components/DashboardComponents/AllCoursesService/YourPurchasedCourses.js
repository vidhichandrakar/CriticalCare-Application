...
function AllCourses() {
  return (
    <main className="main-container">
      ...
      <section>
        <h1 className="Allcoursestext">Purchased Courses</h1>
        <div className="main-cards">
          <div className="card">
            ...
            <div className="cardDate">
              <p>
                <CalendarMonthIcon className="iconDate" />
                Starts on <span>15 DEC 2023</span>
              </p>
              <p>
                <FiberManualRecordIcon className="iconDate" /> Ends on{" "}
            ...
            <div className="CardButton">
              <button className="btn bluecolor BtnPadding">EXPLORE </button>
            </div>
          </div>
          <div className="card">
            <img src={HomeImage} className="cardImage" />
